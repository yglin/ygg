import { generateOnCreateFunctions, generateOnUpdateFunctions, generateOnDeleteFunctions } from '@ygg/the-thing/functions';
import { TheThingImitations } from '@ygg/playwhat/core';
